...
class ApiController extends Controller
{
    ...
    {        
        ...
        //$this->_checkAuth($_GET['uname'],$_GET['upass']);
        switch($_GET['model'])
        {
            case 'events': // {{{ 
    ...
    public function actionView()
    {
        ...
        switch($_GET['model'])
        {
            ...
            case 'events': // {{{ 
                $model = Events::model()->findByPk($_GET['id']);
                break; // }}} 
            default: // {{{ 
     ...
     * @return void
     */
    private function _checkAuth($uname,$upass)
    {
        ...
        */
        ...
        //$username = $_SERVER['demo'];
        //$password = $_SERVER['demo'];
        // Find the user
