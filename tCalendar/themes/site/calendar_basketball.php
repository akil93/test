<?php 
	...
	echo CHtml::link('Last Week', array('site/calendarBasketball', 'theDate'=>$urlDay, 
	...
	echo CHtml::link('Next Week', array('site/calendarBasketball', 'theDate'=>$urlDay,
		'theMonth'=>$urlMonth, 'theYear'=>$urlYear), array('class'=>'links_calendar'));
?>
		...
		<tr>
			...
			<?php foreach($week as $day=>$data): ?>
				 	...
				 	$min = 0;
				 		...
				 		if(Events::model()->findByAttributes(array('fieldtype'=>3,'starttime'=>$hour.$minute.':00','date'=>$y.'-'.$m.'-'.$data))!==null){
				 			//echo ($row/2).$minute.':00';
