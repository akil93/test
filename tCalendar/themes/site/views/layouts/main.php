...
<html lang="ru">
	<head>
		...
		<link rel="stylesheet" href="<?php echo Yii::app()->theme->baseUrl; ?>/css/countdown.css">
		<link rel="stylesheet" href="<?php echo Yii::app()->theme->baseUrl; ?>/css/style_common.css" />
		<link rel="stylesheet" href="<?php echo Yii::app()->theme->baseUrl; ?>/css/style4.css" />
		<link rel="stylesheet" href="<?php echo Yii::app()->theme->baseUrl; ?>/css/camera.css">
		<link rel="stylesheet" href="<?php echo Yii::app()->theme->baseUrl; ?>/css/style.css">
		<script src="<?php echo Yii::app()->theme->baseUrl; ?>/js/jquery.js"></script>
		<script src="<?php echo Yii::app()->theme->baseUrl; ?>/js/jquery-migrate-1.2.1.js"></script>
		...
		<script src="<?php echo Yii::app()->theme->baseUrl; ?>/js/jquery.equalheights.js"></script>
...
<!--==============================header=================================-->
			<header>
				<div class="container_12">
					<div class="grid_12">
						...
						<h1>
							<a href="index.html">
								<img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/logo.png" alt="Your Happy Family">
							</a>
						</h1>
						<?php 
			...
			<div class="slider_wrapper">
				<div id="camera_wrap" class="">
					<div data-src="<?php echo Yii::app()->theme->baseUrl; ?>/images/slide.jpg">
						<div class="caption fadeIn">
							Run for Your Health
						</div>
					</div>
					<div data-src="<?php echo Yii::app()->theme->baseUrl; ?>/images/slide1.jpg">
						<div class="caption fadeIn">
							Fast as Wind
						</div>
					</div>
					<div data-src="<?php echo Yii::app()->theme->baseUrl; ?>/images/slide2.jpg">
						<div class="caption fadeIn">
							Never Stop
						</div>
					</div>
				...
				<div class="container_12">
					...
					<div class="grid_4">
						<div class="box">
							...
							<div class="box_bot">
								<div class="maxheight">
									<img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/page1_img1.jpg" alt=""><a href="#">More</a>
								</div>
							</div>
						</div>
					</div>
					<div class="grid_4">
						<div class="box">
							...
							<div class="box_bot">
								<div class="maxheight">
									<img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/page1_img2.jpg" alt=""><a href="#">More</a>
								</div>
							</div>
						</div>
					</div>
					<div class="grid_4">
						<div class="box">
							...
							<div class="box_bot">
								<div class="maxheight">
									<img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/page1_img3.jpg" alt=""><a href="#">More</a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="grid_7">
						...
						<img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/page1_img4.jpg" alt="" class="img_inner fleft">
					...
					<div class="grid_12">
						<div id="grid" class="main">
							<div class="view">
								...
								<img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/page1_img5.jpg" />
							</div>
							<div class="view">
								<div class="view-back">
								...
								<img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/page1_img6.jpg" />
							</div>
							<div class="view">
								<div class="view-back">
								...
								<img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/page1_img7.jpg" />
							</div>
							<div class="clear"></div>
							<div class="view">
								<div class="view-back">
								...
								<img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/page1_img8.jpg" />
							</div>
							<div class="view">
								<div class="view-back">
								...
								<img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/page1_img9.jpg" />
							</div>
							<div class="view">
								<div class="view-back">
								...
								<img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/page1_img10.jpg" />
							</div>
						</div>
					</div>
					<div class="clear"></div>
...
<!--==============================footer=================================-->
		...
		<script src="<?php echo Yii::app()->theme->baseUrl; ?>/js/cd_config.js"></script>
		<script src="<?php echo Yii::app()->theme->baseUrl; ?>/js/modernizr.custom.69142.js"></script>
